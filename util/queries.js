...
const GET_FB_TOKEN_BY_EMAIL = 'SELECT fcm_token.token FROM fcm_token JOIN Members on Members.memberid = fcm_token.memberid WHERE Members.email = $1;';
...
MISC_QUERIES = {VERIFY_USER_ACCOUNT, INSERT_NEW_MEMBER, GET_FB_TOKEN_BY_EMAIL, GET_USERDATA_BY_EMAIL, GET_FB_TOKEN_BY_ID};

ALL_QUERIES = {VERIFY_USER_ACCOUNT, INSERT_NEW_MEMBER, GET_FB_TOKEN_BY_EMAIL, GET_USERDATA_BY_EMAIL, GET_FB_TOKEN_BY_ID, GET_CHATID_BY_NAME,
    ...
    GET_ALL_MY_MESSAGES, CREATE_CHATROOM_NOT_EXISTS, ADD_MEMBER_TO_CHAT, PROPOSE_CONNECTION, ACCEPT_CONNECTION, FIND_UNIQUE_CONTACT, FIND_CONTACT_BYREST, GET_ALL_CONTACTS, REMOVE_CONNECTION};
